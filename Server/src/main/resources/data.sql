insert into users values ('c1334d57-120b-437b-baef-cf5b5f68cc3e','porofernandez@freljorld.com','Male',null, 'Admin', 'Godlike', '234567890',  true, 'freljorld', 'Admin');
insert into users values ('76b2071a-3f97-4666-bd76-3d3d38ca677d','aocrigane0@slideshare.net','Male',null, 'Juan', 't6YsKgG', '678429049',  false, 'Batista', 'jbatista49');
insert into users values ('a049aff3-d439-4e77-9e3b-e6ffa59d9119','lmorsom1@merriam-webster.com','Male',null, 'Miguel', 'y1hi24h', '643424231',  false, 'Montero', 'mmontero31');
insert into users values ('8c2e01c4-7bbb-4f65-bee5-410df2fa429d','mkimbury2@wp.com','Male',null, 'Lorenzo', 'u3jf2oj', '647293745',  false, 'Castillo', 'lcastillo45');
insert into users values ('40eb045d-1b22-469e-9014-0bc4bbe4a3c1','dberick3@behance.net','Male',null, 'Pablo', 'h3h1hr3', '639443819',  false, 'Belmonte', 'pbelmonte19');
insert into users values ('436eecf5-ca23-4650-8da6-71a9c7a8f99d','jdezamora4@google.co.jp','Male',null, 'Daniel', '7fh37hd', '712191483',  false, 'Zamora', 'dzamora83');
insert into users values ('4b1d3ee3-0baf-4d0e-9aaa-72418b723d3e','tvinnicombe5@webeden.co.uk','Male',null, 'Javier', 'fje82jfe', '715558889',  false, 'Manzano', 'jmanzano89');
insert into users values ('0b1810ec-6191-492c-91b6-04ea0c93dab8','glongmaid6@printfriendly.com','Male',null, 'Martin', 'w8euj1f', '645294912',  false, 'Palacios', 'mpalacios12');
insert into users values ('9dccf8c2-8a7f-4117-a2ca-ae14c35c9abf','tosband7@amazon.co.jp','Female',null, 'Teresa', 'ef1fh91hf', '696142642',  false, 'de Maria', 'tdemaria42');
insert into users values ('bff28d7f-869a-4f0f-ae7e-2c74c23d4746','kheineken8@sitemeter.com','Female',null, 'Laura', '37fh3fhd', '698142732',  false, 'Cerezo', 'lcerezo32');
insert into users values ('3a49cf85-3bfa-40e7-9c54-7db0518696ca','rcrothers9@mlb.com','Female',null, 'Raquel', '3dyd83d', '687128442',  false, 'Hermanas', 'rhermanas42');
insert into users values ('b778d509-c6ee-40b0-9320-93b4601e7f9c','bgaynesfo@over-blog.com','Female',null,'Bella', '37hd823d', '714474232',  false, 'Gallardo', 'bgallardo32');
insert into users values ('a6894032-abf6-4f93-b70e-030bb07dc45a','hhuskc@zimbio.com','Female',null, 'Hilda', 'fh11fh91', '716553900',  false, 'Humarera', 'hhumarera900');
insert into users values ('2e9f78be-6563-42ee-83bb-e8f72c938646','kkellyd@independent.co.uk','Female',null, 'Karen', '73f37ffh', '633594773',  false, 'Kellingstong', 'kkellingstong73');
insert into users values ('7ee77bd1-1563-4937-bb14-ecd3d2503a05','hcowelle@github.com','Female',null, 'Helena', 'fjefj1f', '683471234',  false, 'Collado', 'hcollado34');
insert into users values ('6c3607d4-21c9-4137-a49e-83383b6277ee','lgrigoriof@bizjournals.com','Female',null, 'Lorena', '37hf81f', '693841432',  false, 'Gregorio', 'lgregorio32');
insert into users values ('d6381995-0703-4da7-8206-4c31392b4e9b','acoltang@reuters.com','Female',null, 'Adriana', 'fjo1jf1f', '693231474',  false, 'Colgado', 'acolgado74');
insert into users values ('d8425a3b-c57c-4577-80e2-59a2397db67e','kgertrayh@gravatar.com','Female',null, 'Kelly', 'fhiquhf7', '701412984',  false, 'Gertray', 'kgertray84');
insert into users values ('a12ce02c-4f2e-4cbf-86b1-db5e1e95fba1','fcawderyi@nbcnews.com','Female',null, 'Filomena', 'fhifh1', '698443227',  false, 'Casimiro', 'fcasimiro27');
insert into users values ('4d047ef1-206f-43be-a1c3-d5578c3846d3','tfigurej@163.com','Female',null, 'Tamara', 'feuhfihf1', '684339226',  false, 'Figueroa', 'tfigueroa26');
