...
insert into users values ('76b2071a-3f97-4666-bd76-3d3d38ca677d','aocrigane0@slideshare.net','Male',null, 'Juan', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '678429049', 'Batista', 'jbatista49');
insert into users values ('a049aff3-d439-4e77-9e3b-e6ffa59d9119','lmorsom1@merriam-webster.com','Male',null, 'Miguel', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '643424231', 'Montero', 'mmontero31');
insert into users values ('8c2e01c4-7bbb-4f65-bee5-410df2fa429d','mkimbury2@wp.com','Male',null, 'Lorenzo', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '647293745', 'Castillo', 'lcastillo45');
insert into users values ('40eb045d-1b22-469e-9014-0bc4bbe4a3c1','dberick3@behance.net','Male',null, 'Pablo', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '639443819', 'Belmonte', 'pbelmonte19');
insert into users values ('436eecf5-ca23-4650-8da6-71a9c7a8f99d','jdezamora4@google.co.jp','Male',null, 'Daniel', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '712191483', 'Zamora', 'dzamora83');
insert into users values ('4b1d3ee3-0baf-4d0e-9aaa-72418b723d3e','tvinnicombe5@webeden.co.uk','Male',null, 'Javier', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '715558889', 'Manzano', 'jmanzano89');
insert into users values ('0b1810ec-6191-492c-91b6-04ea0c93dab8','glongmaid6@printfriendly.com','Male',null, 'Martin', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '645294912', 'Palacios', 'mpalacios12');
insert into users values ('9dccf8c2-8a7f-4117-a2ca-ae14c35c9abf','tosband7@amazon.co.jp','Female',null, 'Teresa', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '696142642', 'de Maria', 'tdemaria42');
insert into users values ('bff28d7f-869a-4f0f-ae7e-2c74c23d4746','kheineken8@sitemeter.com','Female',null, 'Laura', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '698142732', 'Cerezo', 'lcerezo32');
insert into users values ('3a49cf85-3bfa-40e7-9c54-7db0518696ca','rcrothers9@mlb.com','Female',null, 'Raquel', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '687128442', 'Hermanas', 'rhermanas42');
insert into users values ('b778d509-c6ee-40b0-9320-93b4601e7f9c','bgaynesfo@over-blog.com','Female',null,'Bella', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '714474232', 'Gallardo', 'bgallardo32');
insert into users values ('a6894032-abf6-4f93-b70e-030bb07dc45a','hhuskc@zimbio.com','Female',null, 'Hilda', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '716553900', 'Humarera', 'hhumarera900');
insert into users values ('2e9f78be-6563-42ee-83bb-e8f72c938646','kkellyd@independent.co.uk','Female',null, 'Karen', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '633594773', 'Kellingstong', 'kkellingstong73');
insert into users values ('7ee77bd1-1563-4937-bb14-ecd3d2503a05','hcowelle@github.com','Female',null, 'Helena', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '683471234', 'Collado', 'hcollado34');
insert into users values ('6c3607d4-21c9-4137-a49e-83383b6277ee','lgrigoriof@bizjournals.com','Female',null, 'Lorena', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '693841432', 'Gregorio', 'lgregorio32');
insert into users values ('d6381995-0703-4da7-8206-4c31392b4e9b','acoltang@reuters.com','Female',null, 'Adriana', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '693231474', 'Colgado', 'acolgado74');
insert into users values ('d8425a3b-c57c-4577-80e2-59a2397db67e','kgertrayh@gravatar.com','Female',null, 'Kelly', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '701412984', 'Gertray', 'kgertray84');
insert into users values ('a12ce02c-4f2e-4cbf-86b1-db5e1e95fba1','fcawderyi@nbcnews.com','Female',null, 'Filomena', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '698443227', 'Casimiro', 'fcasimiro27');
insert into users values ('4d047ef1-206f-43be-a1c3-d5578c3846d3','tfigurej@163.com','Female',null, 'Tamara', '$2a$12$EZKesxbYLoZ6x3/NL.TJSODhGW5jNOpua4j.newEgPCPPZMxfdUo2', '684339226', 'Figueroa', 'tfigueroa26');
...
insert into services values ('c32008c1-86e7-47a8-86c6-0a34d9a971ad', 'Peinados bajo peticiones especiales', null, 'Peinado Especial', 20, 2);
insert into services values ('baeac544-4bef-40f9-aed3-8730f80f27d8', 'Tintura de color completo', null, 'Tinte Color Completo', 28, 3);
insert into services values ('7f5401a6-7862-4b3c-a7cf-1ab90a76da01', 'Mechas de uno o dos de colores', null, 'Mechas', 35, 3);
insert into services values ('3c9a49fa-e203-49ab-9ef0-09d4d7511fb7', 'Tenido gradiente', null, 'Californianas', 50, 3);
insert into services values ('6b428efe-b051-49c7-a6c8-f4bec2b7c8d5', 'Levantado de color', null, 'Decoloración', 60, 2);
insert into services values ('3423fc1b-694e-447b-af7e-2a21ccf45e7c', 'Alisado de keratina', null, 'Alisado de Keratina', 175, 1);
